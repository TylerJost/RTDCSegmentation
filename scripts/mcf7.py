...
register_coco_instances("mcf7_train", {}, jsonAnnotations, imgDir)

# %%
datasetDicts = DatasetCatalog['mcf7_train']()
for d in random.sample(datasetDicts, 3):
    print(d["file_name"])
    img = cv2.imread(d["file_name"])
    visualizer = Visualizer(img[:, :, ::-1], metadata=MetadataCatalog.get('mcf7_train'), scale=0.5)
