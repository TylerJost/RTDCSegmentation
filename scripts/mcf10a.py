...
register_coco_instances("mcf10a_train", {}, jsonAnnotations, imgDir)

# %%
datasetDicts = DatasetCatalog['mcf10a_train']()
for d in random.sample(datasetDicts, 3):
    print(d["file_name"])
    img = cv2.imread(d["file_name"])
    visualizer = Visualizer(img[:, :, ::-1], metadata=MetadataCatalog.get('mcf10a_train'), scale=0.5)
...
cfg.DATASETS.TRAIN = ("mcf10a_train",)
cfg.DATASETS.TEST = ()
...
cfg.OUTPUT_DIR = '../output/splitmcf10a'
